...
bool IsZeroVector(const float* vector, int v_size) {
  return RVV_OR_PORTABLE(IsZeroVector, vector, v_size);
}
...
void SymmetricQuantizeFloats(const float* values, const int size,
  ...
  RVV_OR_PORTABLE(SymmetricQuantizeFloats, values, size, quantized_values, min,
                  max, scaling_factor);
}
...
void SymmetricQuantizeFloats(const float* values, const int size,
  ...
  RVV_OR_PORTABLE(SymmetricQuantizeFloats, values, size, quantized_values,
...
void AsymmetricQuantizeFloats(const float* values, const int size,
                              ...
                              int32_t* offset) {
  RVV_OR_PORTABLE(AsymmetricQuantizeFloats, values, size, quantized_values,
...
void MatrixBatchVectorMultiplyAccumulate(const float* matrix, int m_rows,
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, matrix, m_rows, m_cols,
...
void MatrixBatchVectorMultiplyAccumulate(const int8_t* __restrict__ matrix,
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, matrix, m_rows, m_cols,
                  vector, scaling_factors, n_batch, result);
}
...
void MatrixBatchVectorMultiplyAccumulate(const int8_t* __restrict__ matrix,
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, matrix, m_rows, m_cols,
                  vector, scaling_factors, n_batch, scratch, result, context);
}
...
void SparseMatrixBatchVectorMultiplyAccumulate1x4(
  ...
  RVV_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate1x4, matrix,
...
void SparseMatrixBatchVectorMultiplyAccumulate(
    ...
    float* __restrict__ result) {
  RVV_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate, matrix, ledger,
...
void SparseMatrixBatchVectorMultiplyAccumulate1x16(
  ...
  RVV_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate1x16, matrix,
...
void MatrixBatchVectorMultiplyAccumulate(
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiplyAccumulate, input, bias,
...
void MatrixScalarMultiplyAccumulate(const int8_t* matrix, int32_t scalar,
                                    ...
                                    int32_t* output) {
  RVV_OR_PORTABLE(MatrixScalarMultiplyAccumulate, matrix, scalar, n_row, n_col,
                  output);
}
...
void MatrixBatchVectorMultiply(const int8_t* input, int32_t input_zeropoint,
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiply, input, input_zeropoint,
                  input_to_gate_weights, input_to_gate_effective_scale_a,
                  input_to_gate_effective_scale_b, n_batch, n_input, n_cell,
                  gate_output, gate_output_zp);
}
...
void MatrixBatchVectorMultiply(const int16_t* hidden,
  ...
  RVV_OR_PORTABLE(MatrixBatchVectorMultiply, hidden,
                  hidden_to_output_weights, proj_effective_scale_a,
                  proj_effective_scale_b, gate_bias, n_batch, n_hidden,
                  n_output, output_zp, proj_output);
}
...
void ApplyLayerNorm(const int16_t* input, const int16_t* layer_norm_weights,
  ...
  RVV_OR_PORTABLE(ApplyLayerNorm, input, layer_norm_weights, bias,
...
void ApplyLayerNormFloat(const int16_t* input,
                         ...
                         int16_t* output) {
  RVV_OR_PORTABLE(ApplyLayerNormFloat, input, layer_norm_weights,
                  layer_norm_scale_a, layer_norm_scale_b, bias, n_batch,
                  n_input, output);
}

void ApplySigmoid(const int16_t* input, int32_t n_batch, int32_t n_input,
                  int16_t* output) {
  RVV_OR_PORTABLE(ApplySigmoid, input, n_batch, n_input, output);
}

void ApplySigmoidFloat(const int16_t* input, int32_t n_batch, int32_t n_input,
                       int16_t* output) {
  RVV_OR_PORTABLE(ApplySigmoidFloat, input, n_batch, n_input, output);
}

void ApplyTanh(int32_t integer_bits, const int16_t* input, int32_t n_batch,
               int32_t n_input, int16_t* output) {
  RVV_OR_PORTABLE(ApplyTanh, integer_bits, input, n_batch, n_input, output);
}

void ApplyTanhFloat(const int16_t* input, int32_t n_batch, int32_t n_input,
                    int32_t integer_bits, int16_t* output) {
  RVV_OR_PORTABLE(ApplyTanhFloat, input, n_batch, n_input, integer_bits,
                  output);
}

void CwiseMul(const int16_t* input_1, const int16_t* input_2, int n_batch,
              int n_input, int shift, int16_t* output) {
  RVV_OR_PORTABLE(CwiseMul, input_1, input_2, n_batch, n_input, shift, output);
}

void CwiseMul(const int16_t* input_1, const int16_t* input_2,
              int32_t multiplier, int32_t shift, int32_t n_batch,
              int32_t n_input, int32_t output_zp, int8_t* output) {
  RVV_OR_PORTABLE(CwiseMul, input_1, input_2, multiplier, shift, n_batch,
                  n_input, output_zp, output);
}

void CwiseAdd(const int16_t* input_1, const int16_t* input_2, int n_batch,
              int n_input, int16_t* output) {
  RVV_OR_PORTABLE(CwiseAdd, input_1, input_2, n_batch, n_input, output);
}

void CwiseClipping(float* vector, const int v_size,
                   const float clipping_value) {
  RVV_OR_PORTABLE(CwiseClipping, vector, v_size, clipping_value);
}
...
void VectorBatchVectorCwiseProductAccumulate(const int16_t* vector, int v_size,
  ...
  RVV_OR_PORTABLE(VectorBatchVectorCwiseProductAccumulate, vector, v_size,
                  batch_vector, n_batch, multiplier, shift, result);
}

float VectorVectorDotProduct(const float* vector1, const float* vector2,
                             int v_size) {
  return RVV_OR_PORTABLE(VectorVectorDotProduct, vector1, vector2, v_size);
}

void BatchVectorBatchVectorDotProduct(const int16_t* vector1,
                                      const int16_t* vector2, int v_size,
                                      int n_batch, int32_t* result) {
  RVV_OR_PORTABLE(BatchVectorBatchVectorDotProduct, vector1, vector2, v_size,
                  n_batch, result);
}

void Sub1Vector(const float* vector, int v_size, float* result) {
  RVV_OR_PORTABLE(Sub1Vector, vector, v_size, result);
}
...
void VectorScalarMultiply(const int8_t* vector, int v_size, float scale,
                          float* result) {
  RVV_OR_PORTABLE(VectorScalarMultiply, vector, v_size, scale, result);
}

void ReductionSumVector(const float* input_vector, float* output_vector,
                        int output_size, int reduction_size) {
  RVV_OR_PORTABLE(ReductionSumVector, input_vector, output_vector, output_size,
                  reduction_size);
}
...
void MeanStddevNormalization(const float* input_vector, float* output_vector,
  ...
  RVV_OR_PORTABLE(MeanStddevNormalization, input_vector, output_vector, v_size,
                  n_batch);
}
...
void TwoGateSaturatingAdd(const int8_t* input, int8_t input_zp,
  ...
  RVV_OR_PORTABLE(TwoGateSaturatingAdd, input, input_zp, recurrent,
                  recurrent_zp, input_effective_scale_a,
